...
%setup -q -n e2fsprogs-1.47.2
cd %{_builddir}/e2fsprogs-1.47.2
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a e2fsprogs-1.47.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742826946
...
cp %{_builddir}/e2fsprogs-%{version}/debian/copyright %{buildroot}/usr/share/package-licenses/e2fsprogs/f2bb0b0a826587e7e3f73b544ccbe78d91b5380c || :
...
/usr/share/package-licenses/e2fsprogs/f2bb0b0a826587e7e3f73b544ccbe78d91b5380c
